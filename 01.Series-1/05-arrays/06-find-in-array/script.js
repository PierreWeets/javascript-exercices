...
document.getElementById("run").addEventListener("click", () => {
    ...
    //find the index value of the element ,in the array of object, with firstname & lastname
    let foundPersonid = people.findIndex(el => el.lastname === "Dupont" && el.firstname === "Jean");
    console.log(`email : ${people[foundPersonid].email} `); 
    alert("index :" + foundPersonid);
});